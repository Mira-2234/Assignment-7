export default function Footer() {
  return (
    <footer className="bg-[#244D3F] text-green-100 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <div className="flex gap-3">
            {/* Instagram */}
            <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center cursor-pointer hover:bg-green-300 transition">
